...
% COVER PAGE
%--------------------------------------------------------------------
\includepdf{cover_gt}	% our cover was produced with canva.com
...
C: Course, P: Practical session, S: Scanner Session, D: Discussion.
\input{timetable.tex}

% TALKS 
%---------------------------------------------------------------------
\chapter{List of Courses -- Talks}

\section{Wednesday 17th}
...
\input{abstracts/tex/t\type_c1}
\input{abstracts/tex/t\type_c2}
\input{abstracts/tex/t\type_p3}

\section{Thursday 18th}
\input{abstracts/tex/t\type_p6}
