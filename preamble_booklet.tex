...
\newcommand{\SSScolor}{red!45} % invited speaker
\newcommand{\CScolor}{blue!45} % contributed talk
\newcommand{\PScolor}{orange!45} % keynote lecture
\newcommand{\DIcolor}{yellow!45} %
...
\newcommand{\SSS}[5]{% {time span}{name}{University}{City, Country}{title}
	#1 &\cellcolor{\SSScolor}Scan&{\bfseries#2}\newline #4&&#5 \\ \hline}
\newcommand{\CS}[5]{%
	#1 &\cellcolor{\CScolor}Course&{\bfseries#2}\newline #4&&#5 \\ \hline}
\newcommand{\PS}[5]{%
	#1 &\cellcolor{\PScolor}Practice&{\bfseries#2}\newline #4&&#5 \\ \hline}
\newcommand{\DI}[5]{%
	#1 &\cellcolor{\DIcolor}Discuss&{\bfseries#2}\newline #4&&#5 \\ \hline}
\newcommand{\tutorial}[5]{%
	#1 && {\bfseries#2}\newline #4 &&#5 \\ \hline}
